...
class Writer(Generic[T]):
    ...
    __hash__ = None  # type: ignore[assignment]  # mutable log, as for list
...
def merge_writers(
    ...
    intermediate lists are allocated. The returned values are the same
    objects the writers hold; nothing is shared between the returned
    lists and any writer.
    """
